...
from codetcc.processamento.rabbitmqflow.classesflow import ControlProccess  # uso assim pr quando for rodar fora da ide não dá erro
FILE_PATH = PATH.format("DNE_GU_BAIRROS.TXT")
